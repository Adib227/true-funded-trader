  ...
  return (
    ...
    >
      ...
      <div className="grid lg:flex w-full lg:w-[1600px] mx-auto justify-between ">
        ...
        <div className="w-[420px] h-[290px] bg-gradient-to-b from-[#FF6523] to-[#FFFFFF] rounded-2xl p-6 space-y-3">
          ...
          <p className="text-[12px] font-normal text-black">
            ...
            benefiting from True Funded trader. Once the trading objectives are
        ...
        <div className="w-[420px] h-[290px] bg-gradient-to-b from-[#FF6523] to-[#FFFFFF] rounded-2xl p-6 space-y-3">
          ...
          <p className="text-[12px] font-normal text-black">
            Congratulations! You are now a True Funded Trader. Continue to trade
            consistently and responsibly to quality for up to a 95% profit split
            with virtual account scaling up to $10 Million!
          </p>
        </div>
      </div>
