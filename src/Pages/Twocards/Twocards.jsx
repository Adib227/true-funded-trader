    ...
    >
      <div className="grid lg:flex w-full lg:w-[1550px] mx-auto space-y-16">
        ...
        <div className="pt-12 lg:pt-20 space-y-14">
          <h1 className="text-[26px] font-bold bg-gradient-to-r from-[#00F0FF] via-[#EB00FF] to-[#EB00FF] bg-clip-text text-transparent p-3">
        ...
        <div>
          <h1 className="bg-gradient-to-r from-[#00F0FF] via-[#EB00FF] to-[#EB00FF] bg-clip-text text-transparent text-xl font-bold pb-10 p-3">
