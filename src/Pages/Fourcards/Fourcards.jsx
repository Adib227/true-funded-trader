const Fourcards = () => {
  return (
    ...
    >
      <div className="pt-36 lg:pt-24 font-semibold lg:font-bold text-3xl lg:text-5xl text-center">
        {' '}
      ...
      <div className="grid lg:flex w-full lg:w-[1300px] mx-auto justify-between  ">
        <div className="pt-20">
          ...
          <div className="w-full h-[272px] animate-rotate-border rounded-2xl  bg-conic/[from_var(--border-angle)] from-[#FF6523] to-[#993D1503] from-50% to-70% p-1.5 shadow-orange-400 shadow-[0px_0px_25px_rgba(0,0,0,0.3)] ">
        ...
        <div className="pt-20 pb-12">
          <div className="w-full h-[272px] animate-rotate-border rounded-2xl  bg-conic/[from_var(--border-angle)] from-[#FF6523] to-[#993D1503] from-50% to-70% p-1.5 mb-14 shadow-orange-400 shadow-[0px_0px_25px_rgba(0,0,0,0.3)] ">
            <div className="flex p-8 rounded-2xl bg-gradient-to-r from-[#3918FF] to-[#ADFF27] w-full lg:w-[575px] h-[260px] mx-auto justify-between">
              ...
              <div>
                <img src="https://i.ibb.co.com/S7yqJgKM/Group-6.png" alt="" />
              </div>
            </div>
          </div>
          <div className="w-full h-[272px] animate-rotate-border  rounded-2xl  bg-conic/[from_var(--border-angle)] from-[#FF6523] to-[#993D1503] from-50% to-70% p-1.5 shadow-orange-400 shadow-[0px_0px_25px_rgba(0,0,0,0.3)] ">
            <div className="flex p-8 rounded-2xl bg-gradient-to-r from-[#18FFD5] to-[#C727FF] w-full lg:w-[575px] h-[260px] mx-auto justify-between">
              ...
              <div>
                <img src="https://i.ibb.co.com/MD6sFRGg/x31.png" alt="" />
              </div>
            </div>
          </div>
        </div>
