        ...
        <div className="w-full lg:w-3/4">
          ...
          <div className="grid lg:grid-cols-3  items-center justify-center h-[300px] lg:h-[146px]">
            ...
            <img
              ...
              alt=""
            />
            <div className="absolute ml-auto lg:ml-44 mb-16 w-40 lg:w-80 h-80 bg-pink-300 opacity-30 rounded-full blur-3xl"></div>
            <div className="absolute ml-20 lg:ml-[550px] mb-16 w-60 h-60 bg-pink-300 opacity-30 rounded-full blur-3xl"></div>
          </div>
        </div>
      </div>
    </div>
