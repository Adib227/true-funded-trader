const Featuresection = () => {
  return (
    <div style={{ fontFamily: 'Montserrat, sans-serif' }}>
      ...
      <div className="block lg:flex w-full lg:w-[1500px] mx-auto justify-center lg:justify-evenly space-y-16 lg:space-y-0  py-16 lg:py-0">
        <div className="bg-white p-10 ml-24 lg:ml-0 shadow-2xl rounded-xl -mt-2 lg:-mt-10 text-center w-72 h-40">
          ...
          <div className="absolute w-20 lg:w-96 h-20 lg:h-96 bg-violet-300 opacity-30 rounded-full blur-3xl"></div>
          <div className="absolute ml-0 lg:ml-[500px] w-20 lg:w-96 h-20 lg:h-96 bg-[#FCD13B26] opacity-50 rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="w-full lg:w-3/4">
          ...
          <div className="grid lg:grid-cols-3  items-center justify-center h-[300px] lg:h-[146px]">
            ...
            <img
              ...
              alt=""
            />
            <div className="absolute ml-0 lg:ml-44 mb-16 w-40 lg:w-80 h-80 bg-pink-300 opacity-30 rounded-full blur-3xl"></div>
            <div className="absolute ml-0 lg:ml-[550px] mb-16 w-60 h-60 bg-pink-300 opacity-30 rounded-full blur-3xl"></div>
          </div>
        </div>
      </div>
    </div>
